...
$folder:=$homeFolder.folder("ModernBERT ES")
$path:="modernbert-embed-es-legal-v2-Q8_0.gguf"
$URL:="keisuke-miyako/modernbert-embed-es-legal-v2-gguf-q8_0"
...
$folder:=$homeFolder.folder("ModernBERT ES")
$path:="modernbert-embed-es-legal-v2-onnx-int8"
$URL:="keisuke-miyako/modernbert-embed-es-legal-v2-onnx-int8"
